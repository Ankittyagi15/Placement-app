...
import resourceRoutes from './backend/src/routes/resources.js';
import feedbackRoutes from './backend/src/routes/feedback.js';
import moderationRoutes from './backend/src/routes/moderation.js';
import questionRoutes from './backend/src/routes/questions.js';
import mlRoutes from './backend/src/routes/ml.js';
import { initializeMLModels } from './backend/src/services/ml/modelTrainer.js';
import Resource from './backend/src/models/Resource.js';
import Feedback from './backend/src/models/Feedback.js';
...
async function start() {
  try {
    ...
    try {
      ...
      if (qCount === 0) {
        const { mcqDataset } = await import('./backend/src/seed/mcq-dataset.js');
